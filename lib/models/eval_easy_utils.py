...
def eval_split(matt_dataset, model, opt):
    ...
    for i, image_id in enumerate(matt_dataset.split_image_ids):
        ...
        image_ann_ids = data['ann_ids']  # n ann_ids
        sent_ids = data['sent_ids']  # m sent_id
        gd_ann_ids = data['gd_ann_ids']  # m ann_ids
        ...
        for j, sent_id in enumerate(sent_ids):
            ...
            expanded_labels = label.expand(
                                len(image_ann_ids), max_len) # (n, max_len)
            ...
            pred_ann_id = image_ann_ids[pred_ix]
            pred_box = matt_dataset.Anns[pred_ann_id]['box']  # xywh
            gd_box = gd_boxes[j]
            ...
            entry = {
                ...
                'rel_ann_id': data['cxt_ann_ids'][pred_ix][rel_ix],        
